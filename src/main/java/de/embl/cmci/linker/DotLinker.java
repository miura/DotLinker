...
public class DotLinker {
	...
	public DotLinker(String loadtype, ImagePlus imp, int linkrange, double displacement){
		this.dataload = getIDataLoader(loadtype);
		this.imp = imp;
	...
	ResultsTable showTrajectoryTable(){
		return dataload.showTrajectoryTable(this.all_traj);
	}
	...
	public StackFrames[] dataloader(){
		return dataload.dataLoader(this);
	}
